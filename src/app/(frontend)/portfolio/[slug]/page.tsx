...
import { HighlightSection, GallerySection, PageNavigation } from '@/components/portfolio'
      ...
      <div className="flex w-full flex-col items-center justify-center bg-primary-content">
        <div className="w-full py-6 md:py-8">
          <div className="flex flex-col lg:grid lg:grid-cols-3">
            <div className="lg:col-span-2 px-5 md:px-10 flex flex-col gap-8">
              ...
              {portfolioData.allArticles && (
                <PageNavigation currentSlug={slug} allArticles={portfolioData.allArticles} />
              )}
            </div>

            <div className="mt-8 px-4 lg:col-span-1 lg:mt-0">
